...
public class EditAlimentActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Esto peta!! if (savedInstanceState == null) {
		...
		gramsRationTextView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				builder.setView(v1);
				builder.setTitle(R.string.grams_per_ration);
		...
		// beginning number picker management
